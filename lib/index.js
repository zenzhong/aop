...
(function (factory) {
     ...
     * @Description: 面向切面编程
     */
    var AOP = /** @class */ (function () {
        function AOP(targetFn, ctx) {
            this.ctx = ctx || global;
            this.fnQueue = targetFn ? [targetFn.bind(ctx)] : [];
        }
        AOP.prototype.before = function (beforeFn, ctx) {
            this.fnQueue.unshift(beforeFn.bind(ctx || this.ctx));
            return this;
        };
        AOP.prototype.after = function (afterFn, ctx) {
            this.fnQueue.push(afterFn.bind(ctx || this.ctx));
            return this;
        };
        AOP.create = function (targetFn, ctx) {
            return new AOP(targetFn, ctx || global);
        };
        AOP.prototype.run = function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            _a.label = 1;
                        case 1:
                            if (!(fn = this.fnQueue.shift())) return [3 /*break*/, 3];
                            return [4 /*yield*/, fn()];
                        case 2:
                            curRet = _a.sent();
                            ret.push(curRet);
